...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('citizen_certificates', function (Blueprint $table) {
            ...
            $table->string('prhouse_holding_number')->nullable();
            $table->string('prstreet_nm')->nullable();
            $table->string('prvillage_name')->nullable();
            $table->string('prward_id')->nullable();
            $table->string('prpost_office')->nullable();
            $table->string('prunion_id')->nullable();
            $table->string('prupazila_id')->nullable();
            $table->string('prdistrict_id')->nullable();
