            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <form action="{{route(currentUser().'.warishanfirstpartupdate',Crypt::encrypt($warisan->id))}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            <div class="row m-2">
                                {{-- <div class="col-6">
                                ...
                                <div class="col-sm-2 col-lg-2 ms-0 ps-0">
                                    <input class="form-control datepicker" name="warish_date" value="{{ old('holding_date',\Carbon\Carbon::parse($warisan->warish_date)->format('d-m-Y')) }}" id="warish_date" type="text">
                                </div>
                            </div>
                            <div class="row m-2">
