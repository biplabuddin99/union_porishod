        ...
        <div style="position: relative; margin-top: 15px;">
            ...
            <table style="width: 100%;">
                ...
                <tr>
                    ...
                    <td><input type="text" value="{{ $warishan->district_id }}" class="binput"></td>

                </tr>
                <tr>
                    <th style="width: 25%; text-align: left;">উপজেলা/থানা</th>
                    <td><input type="text" value="{{ $warishan->upazila_id }}" class="binput"></td>
                    <th style="width: 25%; text-align: left; padding-left: 10px;">ইউনিয়ন পরিষদের নাম </th>
                    <td><input type="text" value="{{ $warishan->union_id }}" class="binput"></td>
                </tr>
                <tr>
                    <th style="width: 25%; text-align: left;">ওয়ার্ড </th>
                    <td><input type="text" value="{{ $warishan->ward_id }}" class="binput"></td>
