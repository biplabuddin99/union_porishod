        ...
        <section style="margin-top: 5px;">
            <div class="container">
                <div class="row">
                    ...
                    <h5 class="font-bold text-center" style="color: rgb(8, 104, 5); padding-bottom: 5px;">ওয়ারিশান সনদ নং:  SHARER/2CHUP/24066</h5>
                </div>
                <div class="row">
        ...
        <section class="col-10 offset-1" style="border: 3px solid rgb(122, 101, 4); position: relative;">
            <div class="bgimage">
                ...
                <div class="row m-2">
                    ...
                    <div class="col-5">
                        <span  class="form-label" for="">০৩-০২-২০২৩</span>
                    </div>
                </div>
                <div class="row m-2">
                    <div class="col-1">
