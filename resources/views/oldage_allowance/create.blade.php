    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center bg-primary"
                ...
                <h4 style="color: white; padding-top: 5px;">নতুন বয়স্ক ভাতা আবেদন</h4>
            </div>
        </div>
    </div>
</section>
<section>
    <div class="container">
        <form id="form-data" action="{{route(currentUser().'.oldallowance.store')}}" method="post"
                ...
                <div class="col-md-3 text-center">
                    <label for="cropzee-input">
                        <div class="image-overlay mt-5">
                                <input type="file" name="image" value="" data-default-file="{{ asset('uploads/oldallowance/default.jpg') }}" class="form-control dropify">
                            <div class="overlay">
