    ...
    <section style="font-family: vrinda !important; sans-serif; font-size: 20px !important;">
        ...
        <div class="row text-center m-0 p-0">
            <div class="col-4 m-0 p-0">
                <img height="170px" width="auto" src="{{ asset(request()->session()->get('upsetting')?"uploads/logo_folder/".request()->session()->get('upsetting')->formlogo:'./images/Login-01.png')}}" alt="">
            ...
            <div class="col-4 col-sm-4 m-0 p-0">
                <img class="py-2" height="170px" width="auto" src="{{ asset(request()->session()->get('upsetting')?"uploads/logo_folder/".request()->session()->get('upsetting')->logo:'./images/Login-01.png')}}" alt="">
            ...
            <div class="col-4">
                <img height="180px" width="auto"  src="{{ asset('uploads/holding/thumb') }}/{{ $hold->image }}" onerror="this.onerror=null;this.src='{{ asset('uploads/onerror.jpg')}}';" alt="কোন ছবি পাওয়া যায় নি">
            </div>
        </div>
