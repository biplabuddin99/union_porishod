                        ...
                        <form action="{{route(currentUser().'.trade.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row m-2">
                                ...
                                <div class="col-sm-2 col-lg-2 ms-0 ps-0">
                                    <input class="form-control datepicker" name="trade_date" value="<?= date('d-m-Y'); ?>" id="trade_date" type="text">
                                </div>
                            </div>
                            <div class="row m-2">
                                <div class="col-6 mb-2">
                                    ...
                                    name="head_institution" value="{{ old('head_institution') }}" id="head_institution" placeholder="প্রতিষ্ঠানের প্রধানের নাম">
