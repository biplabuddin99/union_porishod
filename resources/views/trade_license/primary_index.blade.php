        ...
        <div style="position: relative; margin-top: 15px;">
            ...
            <table style="width: 100%;">
                ...
                <tr>
                    ...
                    <td><input type="text" value="{{ $hold->business_name }}" class="binput"></td>
                    <th style="width: 25%; text-align: left; padding-left: 10px;">মালিক/প্রোপাইটরের নাম</th>
                    <td><input type="text" value="{{ $hold->owner_proprietor }}" class="binput"></td>
                </tr>
                <tr>
                    <th style="width: 25%; text-align: left;">স্বমীর নাম</th>
                    <td><input type="text" value="{{ $hold->trade_husband_name }}" class="binput"></td>
                    <th style="width: 25%; text-align: left; padding-left: 10px;">পিতার নাম</th>
                    <td><input type="text" value="{{ $hold->trade_fathername }}" class="binput"></td>
                </tr>
                <tr>
                    <th style="width: 25%; text-align: left;">মাতার নাম</th>
                    <td><input type="text" value="{{ $hold->trade_mothername }}" class="binput"></td>
                    <th style="width: 25%; text-align: left; padding-left: 10px;">ট্রেড লােইসেন্স নবায়ন</th>
                    <td style="border: 1px solid rgb(19, 18, 18);"> @if ($hold->trade_license_renewal == 1 ) অর্থ বছর ২০২৩-২০২৪ @elseif($hold->trade_license_renewal == 2 ) অর্থ বছর ২০২৪-২০২৫@elseif($hold->trade_license_renewal == 3 ) অর্থ বছর ২০২৫-২০২৬@elseif($hold->trade_license_renewal == 4 ) অর্থ বছর ২০২৬-২০২৭@elseif($hold->trade_license_renewal == 5 ) অর্থ বছর ২০২৭-২০২৮@elseif($hold->trade_license_renewal == 6 ) অর্থ বছর ২০২৮-২০২৯ @endif</td>
                </tr>
                <tr>
                    <th style="width: 25%; text-align: left;">প্রতিষ্ঠানের মালিকানার ধরন</th>
                    <td style="border: 1px solid rgb(19, 18, 18);"> @if ($hold->type_ownership_organization == 1 ) একক @elseif($hold->type_ownership_organization == 2 ) যৌথ@elseif($hold->type_ownership_organization == 3 )কোম্পানি @endif</td>
                    <th style="width: 25%; text-align: left; padding-left: 10px;">ব্যবসায়িক ধরন</th>
                    <td style="border: 1px solid rgb(19, 18, 18);">
                        @if ($hold->business_type == 1 ) কৃষি খামার
                        @elseif($hold->business_type == 2 ) মুদির দোকান
                        @elseif($hold->business_type == 3 ) আবাসিক হোটেল
                        @elseif($hold->business_type == 4 ) খাবারের হোটেল
                        @elseif($hold->business_type == 5 ) স’মিল
                        @elseif($hold->business_type == 6 ) শিল্প কারখানা
                        @elseif($hold->business_type == 7 ) বাজার ইজারা
                        @elseif($hold->business_type == 8 ) নৌযানের মালিক
                        @elseif($hold->business_type == 9 ) পশু জবাই
                        @elseif($hold->business_type == 10 ) দুগ্ধ খামার
                        @elseif($hold->business_type == 11 ) ক্ষুদ্র ও কুটির শিল্প
                        @elseif($hold->business_type == 12 ) বেসরকারী হাসপাতাল
                        @elseif($hold->business_type == 13 ) ধান ভাঙানোর কল
                        @elseif($hold->business_type == 14 ) হেয়ার কাট সেলুন
                        @elseif($hold->business_type == 15 ) কনসালটেন্সি ফার্ম
                        @elseif($hold->business_type == 16 ) বাসের মালিক
                        @elseif($hold->business_type == 17 ) স্টীমার/কার্গোর মালিক
                        @elseif($hold->business_type == 18 ) গবাদি পশুর খামার
                        @elseif($hold->business_type == 19 ) খাবার হোটেল
                        @elseif($hold->business_type == 20 ) ঔষদের দোকান
                        @elseif($hold->business_type == 21 ) কোচিং সেন্টার
                        @elseif($hold->business_type == 22 ) মৎস্য খামার
                        @elseif($hold->business_type == 23 ) আর্থিক প্রতিষ্ঠান
                        @elseif($hold->business_type == 24 ) মিষ্টির দোকান
                        @elseif($hold->business_type == 25 ) হিমাগার
                        @elseif($hold->business_type == 26 ) বিউটি পার্লার
                        @elseif($hold->business_type == 27 ) ইট ভাটা
                        @elseif($hold->business_type == 28 ) ঠিকাদার
                        @elseif($hold->business_type == 29 ) হাঁস-মুরগীর খামার
                        @elseif($hold->business_type == 30 ) মাঝারি শিল্প
                        @elseif($hold->business_type == 31 ) ক্লিনিক
                        @elseif($hold->business_type == 32 ) বে-সরকারী স্কুল
                        @elseif($hold->business_type == 33 ) আটার কল
                        @elseif($hold->business_type == 34 ) লন্ড্রীর দোকান
                        @elseif($hold->business_type == 35 )গুদাম
                        @elseif($hold->business_type == 36 )শিশু পার্ক
                        @elseif($hold->business_type == 37 )ইঞ্জিনিয়ারিং ফার্ম
                        @elseif($hold->business_type == 38 )তেলের কল
                        @elseif($hold->business_type == 39 )পরিবহন এজেন্সি
                        @elseif($hold->business_type == 40 )বিনোদন পার্ক
                        @elseif($hold->business_type == 41 )শিক্ষক
                        @elseif($hold->business_type == 42 )অন্যান্য
                        @endif</td>
                </tr>
                <tr>
