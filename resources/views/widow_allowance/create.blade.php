...
{{-- @section('pageTitle','বিধবা ভাতা আবেদন') --}}
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center bg-primary"
                ...
                <h4 style="color: white; padding-top: 5px;">বিধবা ভাতা আবেদন</h4>
            </div>
        </div>
    </div>
</section>
<section>
    <div class="container">
        <form id="form-data" action="{{route(currentUser().'.widowallowance.store')}}" method="post"
                ...
                <div class="col-md-3 text-center">
                    <label for="cropzee-input">
                        <div class="image-overlay mt-5">
                                <input type="file" name="image" value="" data-default-file="{{ asset('uploads/widowallowance/default.jpg') }}" class="form-control dropify">
                            <div class="overlay">
                ...
                <div class="col-md-12">
                    <div class="row form-group">
                        ...
                        <div class="col-sm-3 bt-flabels__wrapper" id="name_bn_status">
                            <input type="text" name="name_bn" id="name_bn" value="" required
                                class="form-control @error('name_bn') is-invalid @enderror" placeholder="পূর্ণ নাম" />
                ...
                <div class="col-sm-12">
                    <div class="row form-group">
                        ...
                        <div class="col-sm-3 bt-flabels__wrapper" id="permanent_postoffice_id_status">
                            <select name="permanent_postoffice_id" id="permanent_postoffice_id" class="form-control">
                            ...
                            {{-- <select onchange="getLocation($(this).val(), 'permanent_postoffice')"
                                name="permanent_postoffice_id" id="permanent_postoffice_id1" class="form-control"
                                data-parsley-required>
...
<script type="text/javascript">
    ...
    if ($('#permanentBtn').is(":checked")) {
        ...
        var district = $('#present_district_id option:selected').val();
        $('#permanent_district_id option[value=' + district + ']').attr('selected','selected');
        var upazila = $('#present_upazila_id option:selected').val();
        $('#permanent_upazila_id option[value=' + upazila + ']').attr('selected','selected');
        var ward = $('#present_ward_no option:selected').val();
        $('#permanent_ward_no option[value=' + ward + ']').attr('selected','selected');
        var postoffice = $('#present_postoffice_id option:selected').val();
        $('#permanent_postoffice_id option[value=' + postoffice + ']').attr('selected','selected');
    }else{
        ...
        $('#permanent_district_id option[value=""]').attr('selected','selected');
        $('#permanent_upazila_id option[value=""]').attr('selected','selected');
        $('#permanent_ward_no option[value=""]').attr('selected','selected');
        $('#permanent_postoffice_id option[value=""]').attr('selected','selected');
    };
