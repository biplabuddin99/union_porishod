...
{{-- @section('pageTitle','ভিজিএফ কার্ড আবেদন') --}}
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center bg-primary"
                ...
                <h4 style="color: white; padding-top: 5px;">ভিজিএফ কার্ড আবেদন</h4>
            </div>
        </div>
    </div>
</section>
<section>
    <div class="container">
        <form id="form-data" action="{{route(currentUser().'.vgfcard.store')}}" method="post"
