                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12 text-center heading-block">
                                    <h5 style="padding-top: 5px;">স্থায়ী বাসিন্দার অন্যান্য তথ্য</h5>
                                </div>
                            </div>
                        </div>
                        <form action="{{route('permanentsecondpart_update',Crypt::encrypt($permanent->id))}}" role="form" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                            @csrf
                            @method('POST')
                            <div class="row m-2">
                                <div class="col-6">
