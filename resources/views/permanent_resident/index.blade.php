                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 text-center heading-block">
                            <h5 style="padding-top: 5px;">স্থায়ী বাসিন্দার আবেদন তালিকা</h5>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table" id="table1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$p->income?->name}}</td>
                                <td>{{$p->phone}}</td>
                                <td><img width="70px" height="50px" src="{{ asset('uploads/permanent') }}/{{ $p->image }}" onerror="this.onerror=null;this.src='{{ asset('uploads/onerror.jpg')}}';" alt=""></td>
                                <td>
                                                        ...
                                                        <div class="col-md-12">
                                                            <table class="table table-inverse table-responsive">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <form action="{{route('permanents_profile',encryptor('encrypt',$p->id))}}">
                                                                        @csrf
                                                                        @method('PATCH')
                                                                        <tr>
                                                                            <td>সনদ ফি</td>
                                ...
                                <td>
                                    <a href="{{route('permanent_primary.list',Crypt::encrypt($p->id))}}">
                                ...
                                <td>
                                    <a  href="{{route(currentUser().'.permanentresident.edit',encryptor('encrypt',$p->id))}}">
                            ...
                            @empty
                            <tr>
                                <th colspan="8" class="text-center">No permanent resident certificate Found</th>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
