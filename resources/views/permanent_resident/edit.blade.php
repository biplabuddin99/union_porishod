                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12 text-center heading-block">
                                    <h4 style="padding-top: 5px;">স্থায়ী বাসিন্দা সনদ আপডেট করুন</h4>
                                </div>
                            </div>
                        </div>
                        <form action="{{route(currentUser().'.permanentresident.update',encryptor('encrypt',$permanent->id))}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <div class="row m-2">
                                {{-- <div class="col-6">
                                ...
                                <div class="col-sm-2 col-lg-2 ms-0 ps-0">
                                    <input class="form-control datepicker" name="apply_date" value="{{ old('holding_date',\Carbon\Carbon::parse($permanent->apply_date)->format('d-m-Y')) }}" id="apply_date" type="text">
                                </div>
                            </div>
                            <div class="row m-2">
                                <div class="col-6 mb-2">
                                    ...
                                    name="applicant_name" value="{{ old('applicant_name',$permanent->applicant_name) }}" id="applicant_name" placeholder="আবেদনকারীর নাম">
                                ...
                                <div class="col-6 mb-2">
                                    ...
                                    name="father_name" value="{{ old('father_name',$permanent->father_name) }}" id="father_name" placeholder="পিতার নাম">
                                ...
                                <div class="col-6 mb-2">
                                    ...
                                    name="mother_name" value="{{ old('mother_name',$permanent->mother_name) }}" id="mother_name" placeholder="মাতার নাম">
                                ...
                                <div class="col-6 mb-2">
                                    ...
                                    name="husband_wife" value="{{ old('husband_wife',$permanent->husband_wife) }}" id="husband_wife" placeholder="স্বামী/স্ত্রীর নাম">
                                </div>
                                ...
                                <div class="col-6 mb-2">
                                    ...
                                    name="birth_date" id="birth_date" value="{{ old('birth_date',$permanent->birth_date) }}"  type="text" placeholder="দিন-মাস-সাল">
                                ...
                                <div class="col-6 mb-2">
                                    ...
                                    <input class="form-control @error('voter_id_no') is-invalid @enderror" type="text" name="voter_id_no" id="voter_id_no" value="{{ old('voter_id_no',$permanent->voter_id_no) }}" placeholder="ভোটার আইডি নং">
                                ...
                                <div class="col-6 mb-2">
                                    ...
                                    name="birth_registration_id" value="{{ old('birth_registration_id',$permanent->birth_registration_id) }}" id="birth_registration_id" placeholder="জন্মনিবন্ধন আইডি">
                                ...
                                <div class="col-6">
                                    ...
                                    <select name="gender" id="gender1" class="form-select @error('gender') is-invalid @enderror">
                                        ...
                                        <option value="1" {{ old('gender', $permanent->gender)=="1" ? "selected":""}}>পুরুষ</option>
                                        <option value="2" {{ old('gender', $permanent->gender)=="2" ? "selected":""}}>মহিলা</option>
                                        <option value="3" {{ old('gender', $permanent->gender)=="3" ? "selected":""}}>তৃতীয় লিঙ্গ</option>
                                    </select>
                                ...
                                <div class="col-6">
                                    ...
                                    <select name="religion" class="form-select @error('religion') is-invalid @enderror">
                                        <option value="">নির্বাচন করুন</option>
                                        <option value="1" {{ old('religion', $permanent->religion)=="1" ? "selected":""}}>ইসলাম</option>
                                        <option value="2" {{ old('religion', $permanent->religion)=="2" ? "selected":""}}>হিন্দু</option>
                                        <option value="3" {{ old('religion', $permanent->religion)=="3" ? "selected":""}}>বৌদ্ধ</option>
                                        <option value="4" {{ old('religion', $permanent->religion)=="4" ? "selected":""}}>খ্রিষ্টান</option>
                                        <option value="5" {{ old('religion', $permanent->religion)=="5" ? "selected":""}}>উপজাতি</option>
                                    </select>
                                ...
                                <div class="col-6">
                                    ...
                                    <select name="marital_status" id="marit" class="form-select">
                                        <option value="">নির্বাচন করুন</option>
                                        <option value="1" {{ old('marital_status', $permanent->marital_status)=="1" ? "selected":""}}>বিবাহিত</option>
                                        <option value="2" {{ old('marital_status', $permanent->marital_status)=="2" ? "selected":""}}>অবিবাহিত</option>
                                    </select>
                                </div>
                                <div class="col-6">
                                    ...
                                    <select name="freedom_fighter" class="form-select @error('freedom_fighter') is-invalid @enderror">
                                        <option value="">নির্বাচন করুন</option>
                                        <option value="1" {{ old('freedom_fighter', $permanent->freedom_fighter)=="1" ? "selected":""}}>বীর মুক্তিযোদ্ধা</option>
                                        <option value="2" {{ old('freedom_fighter', $permanent->freedom_fighter)=="2" ? "selected":""}}>বীরাঙ্গনা</option>
                                        <option value="3" {{ old('freedom_fighter', $permanent->freedom_fighter)=="3" ? "selected":""}}>নাই</option>
                                    </select>
                                ...
                                <div class="col-6">
                                    ...
                                    <select name="edu_qual" class="form-select @error('edu_qual') is-invalid @enderror">
                                        ...
                                        @forelse(\App\Models\EducationalQualification::orderBy('created_at')->get() as $data)
                                            <option value="{{$data->id}}" {{ old('edu_qual', $permanent->edu_qual)==$data->id ? "selected":""}}>{{$data->name}}</option>
                                        @empty
                                        @endforelse
                                    </select>
                                </div>
                            ...
                            <div class="row m-2">
                                <div class="col-6">
                                    ...
                                    <select required name="source_income" class="form-select @error('source_income') is-invalid @enderror">
                                        ...
                                        @forelse(\App\Models\Profession::orderBy('created_at')->get() as $data)
                                            <option value="{{$data->id}}" {{ old('source_income', $permanent->source_income)==$data->id ? "selected":""}}>{{$data->name}}</option>
                                        @empty
                                        @endforelse
                                    </select>
                                </div>
                                <div class="col-6 mb-2">
                                    ...
                                    <input class="form-control @error('phone') is-invalid @enderror" required name="phone" id="phone" value="{{ old('phone',$permanent->phone) }}"  type="text" placeholder="মোবাইল নম্বর">
                                    @if($errors->has('phone'))
                                ...
                                <div class="col-6 mb-2">
                                    ...
                                    <input class="form-control" type="email" name="email" id="email" value="{{ old('email',$permanent->email) }}" placeholder=".....@email.com">
                                </div>
                                <div class="col-6 mb-2">
                                    <label class="form-label" for="bank_acc"><b>ব্যাংক একাউন্ট</b></label>
                                    <select required name="bank_acc" id="bank_acc" class="form-select">
                                        <option value="">নির্বাচন করুন</option>
                                        <option value="1" {{ old('bank_acc', $permanent->bank_acc)=="1" ? "selected":""}}>আছে</option>
                                        <option value="2" {{ old('bank_acc', $permanent->bank_acc)=="2" ? "selected":""}}>নাই</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row m-2">
                                <div class="col-6">
                                    ...
                                    <select name="permanent_resident" class="form-select @error('permanent_resident') is-invalid @enderror">
                                        <option value="">নির্বাচন করুন</option>
                                        <option value="1" {{ old('permanent_resident', $permanent->permanent_resident)=="1" ? "selected":""}}>স্থায়ী বাসিন্দা</option>
                                        <option value="2" {{ old('permanent_resident', $permanent->permanent_resident)=="2" ? "selected":""}}>অস্থায়ী বাসিন্দা</option>
                                    </select>
                                ...
                                <div class="col-6">
                                    ...
                                    <select name="citizen_bangladesh" class="form-select @error('citizen_bangladesh') is-invalid @enderror">
                                        <option value="">নির্বাচন করুন</option>
                                        <option value="1" {{ old('citizen_bangladesh', $permanent->citizen_bangladesh)=="1" ? "selected":""}}>হ্যাঁ</option>
                                        <option value="2" {{ old('citizen_bangladesh', $permanent->citizen_bangladesh)=="2" ? "selected":""}}>না</option>
                                    </select>
                            ...
                            <div class="row m-2">
                                <div class="col-6">
                                    ...
                                    <select name="voters_union" class="form-select @error('voters_union') is-invalid @enderror">
                                        <option value="">নির্বাচন করুন</option>
                                        <option value="1" {{ old('voters_union', $permanent->voters_union)=="1" ? "selected":""}}>হ্যাঁ</option>
                                        <option value="2" {{ old('voters_union', $permanent->voters_union)=="2" ? "selected":""}}>না</option>
                                    </select>
                                ...
                                <div class="col-6">
                                    ...
                                    name="voter_no" id="voter_no" value="{{ old('voter_no', $permanent->voter_no) }}"  type="number" placeholder="ভোটার নম্বর">
                            ...
                            <div class="row m-2">
                                <div class="col-6">
                                    ...
                                    <select name="involved_anti_state" class="form-select @error('involved_anti_state') is-invalid @enderror">
                                        <option value="">নির্বাচন করুন</option>
                                        <option value="1" {{ old('involved_anti_state', $permanent->involved_anti_state)=="1" ? "selected":""}}>আছে</option>
                                        <option value="2" {{ old('involved_anti_state', $permanent->involved_anti_state)=="2" ? "selected":""}}>নাই</option>
                                    </select>
                            ...
                            <div class="row m-2">
                                <div class="col-6">
                                    ...
                                    name="house_holding_no" id="house_holding_no" value="{{ old('house_holding_no',$permanent->house_holding_no) }}"  type="text" placeholder="ইউনিয়ন পরিষদ কতৃক পূরণকৃত">
                                ...
                                <div class="col-6">
                                    ...
                                    name="street_nm" id="street_nm" value="{{ old('street_nm',$permanent->street_nm) }}"  type="text" placeholder="রাস্তা/পাড়া/মহল্লা">
                                ...
                                <div class="col-6">
                                    ...
                                    name="village_name" id="village_name" value="{{ old('village_name',$permanent->village_name) }}"  type="text" placeholder="গ্রামের নাম">
                                ...
                                <div class="col-6">
                                    ...
                                    <select name="ward_id" class="form-select" id="ward_id">
                                        ...
                                        @forelse ($ward as $w)
                                        <option value="{{ $w->id }}" {{ $permanent->ward_id==$w->id ? "selected":""}}>{{ $w->ward_name_bn }}</option>
                                        @empty
                                        <p>No Ward found</p>
                                        @endforelse
                                    </select>
                                ...
                                <div class="col-6">
                                    ...
                                    name="post_office" id="post_office" value="{{ old('post_office',$permanent->post_office) }}"  type="text" placeholder="ডাকঘর">
                            ...
                            <div class="row m-0 p-0">
                                <div class="image-overlay">
                                    <label  class="form-label" for="image">সদ্য তোলা রঙিন ছবি</label>
                                        <input type="file" name="image" value="" data-default-file="{{ asset('uploads/permanent') }}/{{ $permanent->image }}" class="form-control dropify">
                                </div>
                            </div>
