          ...
          <div class="col-12">
              <div class="card">
                  <div class="card-content">
                      <div class="card-body">
                          <form class="form" method="post" enctype="multipart/form-data" action="{{route(currentUser().'.others.store')}}">
                            <input type="hidden" name="all_aplication" value="{{$all->id}}">
                              @csrf
                              <div class="row m-2">
                                <div class="col-6">
                                    <label  class="form-label" for="warishan_person_name">পরিবারের প্রধানের নাম:-</label>
                            ...
                            <div class="row m-3">
                                <h4 class="" style="color: rgb(13, 134, 29); padding-top: 5px;">বাংলাদেশের আইন অনুযায়ী উপরোক্ত ব্যাক্তির পরিবারের সদস্যদের বিবরণ সমূহঃ- </h4>
                            </div>
                            <div class="col-12 ">
