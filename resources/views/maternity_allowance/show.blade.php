...
<section>
    <div class="row">
            ...
            <div class="col-md-12 mb-3">
                <div class="row form-group">
                    ...
                    <div class="col-sm-3 bt-flabels__wrapper" id="birth_registration">
                        <div>{{ $maternity->birth_registration }}</div>
                    </div>
            ...
            <div class="col-md-12 mb-3">
                <div class="row form-group">
                    ...
                    <div class="col-sm-3 bt-flabels__wrapper" id="father_name_en">
                        <div>{{ $maternity->father_name_en }}</div>
                    </div>
                    ...
                    <div class="col-sm-3 bt-flabels__wrapper" id="father_name_bn">
                        <div>{{ $maternity->father_name_bn }}</div>
                    </div>
                </div>
            </div>
            <div class="col-md-12 mb-3">
                <div class="row form-group">
                    ...
                    <div class="col-sm-3 bt-flabels__wrapper" id="mother_name_en">
                        <div>{{ $maternity->mother_name_en }}</div>
                    </div>
                    ...
                    <div class="col-sm-3 bt-flabels__wrapper" id="mother_name_bn">
                        <div>{{ $maternity->mother_name_bn }}</div>
                    </div>
                </div>
            </div>
            <div class="col-md-12">
            ...
            <div class="col-md-12">
                <div class="row form-group">
                    ...
                    <div class="col-sm-3 bt-flabels__wrapper" id="educational_qualification">
                        <div>{{ $maternity->educational_qualification }}</div>
                    </div>
                    <label for="religion" class="col-sm-3 control-label">ধর্ম  :</label>
                    <div class="col-sm-3 bt-flabels__wrapper" id="religion">
                        <div>@if($maternity->religion == "1")
                             <p> ইসলাম ধর্ম</p>
                            @elseif($maternity->religion == "2")
                            <p>হিন্দু ধর্ম</p>
                            @elseif($maternity->religion == "3")
                            <p>বৌদ্ধ ধর্ম</p>
                            @elseif($maternity->religion == "4")
                            <p>খ্রিস্ট ধর্ম</p>
                            @else
                            <p>অন্যান্য</p>
                            @endif
            ...
            <div class="col-md-12">
                <div class="row form-group">
                    ...
                    <div class="col-sm-3 bt-flabels__wrapper" id="gender">
                        <div>@if($maternity->gender == "1")
                            <p>পুরুষ</p>
                           @elseif($maternity->gender == "2")
                           <p>মহিলা</p>
                           @else
                           <p>অন্যান্য</p>
                           @endif
                    ...
                    <div class="col-sm-3 bt-flabels__wrapper" id="marital_status">
                        <div>@if($maternity->marital_status == "1")
                            <p> অবিবাহিত</p>
                           @elseif($maternity->marital_status == "2")
                           <p>বিবাহিত</p>
                           @elseif($maternity->marital_status == "3")
                           <p>তালাক প্রাপ্ত</p>
                           @elseif($maternity->marital_status == "4")
                           <p>বিধবা</p>
                           @else
                           <p>অন্যান্য</p>
                           @endif
        ...
        <div class="col-md-3">
            <img class="mt-5" height="200px" width="200px" src="{{asset('uploads/maternity')}}/{{ $maternity->image}}" alt="No Image">
            <div class="text-center">{{ $maternity->name_bn }}</div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="row form-group">
                ...
                <div class="col-sm-3 bt-flabels__wrapper" id="present_village_en">
                    <div>{{ $maternity->present_village_en }}</div>
                </div>
                ...
                <div class="col-sm-3 bt-flabels__wrapper" id="present_village_bn">
                    <div>{{ $maternity->present_village_bn }}</div>
                </div>
            </div>
        </div>
        <div class="col-md-12">
            <div class="row form-group">
                ...
                <div class="col-sm-3 bt-flabels__wrapper" id="present_rbs_en">
                    <div>{{ $maternity->present_rbs_en }}</div>
                </div>
                ...
                <div class="col-sm-3 bt-flabels__wrapper" id="present_rbs_bn">
                    <div>{{ $maternity->present_rbs_bn }}</div>
                </div>
            </div>
        </div>
        <div class="col-md-12">
            <div class="row form-group">
                ...
                <div class="col-sm-3 bt-flabels__wrapper" id="present_holding_no">
                    <div>{{ $maternity->present_holding_no }}</div>
                </div>
                ...
                <div class="col-sm-3 bt-flabels__wrapper" id="present_ward_no">
                    <div>{{ $maternity->present_ward_no }}</div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-12">
            <div class="row form-group">
                ...
                <div class="col-sm-3 bt-flabels__wrapper" id="permanent_village_en">
                    <div>{{ $maternity->permanent_village_en }}</div>
                </div>
                ...
                <div class="col-sm-3 bt-flabels__wrapper" id="permanent_village_bn">
                    <div>{{ $maternity->permanent_village_bn }}</div>
                </div>
            </div>
        </div>
        <div class="col-md-12">
            <div class="row form-group">
                ...
                <div class="col-sm-3 bt-flabels__wrapper" id="permanent_rbs_en">
                    <div>{{ $maternity->permanent_rbs_en }}</div>
                </div>
                ...
                <div class="col-sm-3 bt-flabels__wrapper" id="permanent_rbs_bn">
                    <div>{{ $maternity->permanent_rbs_bn }}</div>
                </div>
            </div>
        </div>
        <div class="col-md-12">
            <div class="row form-group">
                ...
                <div class="col-sm-3 bt-flabels__wrapper" id="permanent_holding_no">
                    <div>{{ $maternity->permanent_holding_no }}</div>
                </div>
                ...
                <div class="col-sm-3 bt-flabels__wrapper" id="permanent_ward_no">
                    <div>{{ $maternity->permanent_ward_no }}</div>
                </div>
            </div>
        </div>
        <div class="col-md-12">
                ...
                <div class="col-sm-3 bt-flabels__wrapper" id="permanent_district_id">
                    <select style="width: 280px; border: 0px !important; box-shadow: none !important;" class="form-control" id="permanent_district_id" name="permanent_district_id">
                        @forelse($district as $dis)
                            <option disabled  value="{{$dis->id}}" {{$maternity->permanent_district_id== $dis->id ? 'selected' : ''}}>{{$dis->name_bn}}</option>
                        @empty
                            <option>No data found</option>
                        @endforelse
                    </select>
                    {{-- <div>{{ $maternity->permanent_district_id }}</div> --}}
                </div>
                ...
                <div class="col-sm-3 bt-flabels__wrapper" id="permanent_upazila_id">
                    <select style=" border: 0px !important; box-shadow: none !important;" class="form-control" id="permanent_upazila_id" name="permanent_upazila_id">
                        @forelse($thana as $tha)
                            <option disabled  value="{{$tha->id}}" {{$maternity->permanent_upazila_id== $tha->id ? 'selected' : ''}}>{{$tha->name_bn}}</option>
                        @empty
                            <option>No data found</option>
                        @endforelse
                    </select>
                    {{-- <div>{{ $maternity->permanent_upazila_id }}</div> --}}
                </div>
            </div>
        </div>
    </div>
