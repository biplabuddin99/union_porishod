...
@section('pageTitle','প্রতিবন্ধী সনদের আপডেট')
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center bg-primary"
                ...
                <h4 style="color: white; padding-top: 5px;">প্রতিবন্ধী সনদের আপডেট</h4>
            </div>
        </div>
    </div>
</section>
<section>
    <div class="container">
        <form id="form-data" action="{{route(currentUser().'.disablity.update',encryptor('encrypt',$disability->id))}}" method="post"
