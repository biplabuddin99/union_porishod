                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 text-center heading-block">
                            <h5 style="padding-top: 5px;">পারিবারিক সনদের আবেদন তালিকা</h5>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table" id="table1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a  href="{{route(currentUser().'.family.edit',encryptor('encrypt',$p->id))}}">
                            ...
                            @empty
                            <tr>
                                <th colspan="8" class="text-center">No family Found</th>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
