                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12 text-center heading-block">
                                    <h5 style="padding-top: 5px;">পারিবারিক সনদ আবেদন ফরম</h5>
                                </div>
                            </div>
                        </div>
                        <form action="{{route(currentUser().'.familyfirstpartupdate',Crypt::encrypt($family->id))}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            <div class="row m-2">
                                {{-- <div class="col-6">
