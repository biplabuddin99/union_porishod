                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 text-center heading-block">
                            <h5 style="padding-top: 5px;">নাগরিক সনদের আবেদন তালিকা</h5>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table" id="table1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                                        ...
                                                        <div class="col-md-12">
                                                            <table class="table table-inverse table-responsive">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <form action="{{route('citizens_profile',encryptor('encrypt',$p->id))}}">
                                                                        @csrf
                                                                        @method('PATCH')
                                                                        <tr>
                                ...
                                <td>
                                    <a  href="{{route(currentUser().'.citizen.edit',encryptor('encrypt',$p->id))}}">
