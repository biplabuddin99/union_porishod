...
use App\Models\WidowAllowance;
use App\Models\Settings\Location\District;
use App\Models\Settings\Location\Thana;
use App\Models\Ward_no;
use Illuminate\Http\Request;
use App\Http\Requests\WidowAllowanceCreate;
use Brian2694\Toastr\Facades\Toastr;
use App\Http\Traits\ImageHandleTraits;
use Exception;

class WidowAllowanceController extends Controller
{
    ...
    {
        $windowallowance=WidowAllowance::all();
        return view('widow_allowance.index',compact('windowallowance'));
    ...
    public function create()
    {
        ...
        $thana=Thana::all();
        $ward=Ward_no::all();
        return view('widow_allowance.create',compact('district','thana','ward'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(WidowAllowanceCreate $request)
    {
        try{
            $p=new WidowAllowance;
            ...
            $p->image=$this->resizeImage($request->image,'uploads/widowallowance',true,300,300,false);

            if($p->save()){
            Toastr::success('বিধবা ভাতা আবেদন সফলভাবে সম্পন্ন হয়েছে!!');
            return redirect()->route(currentUser().'.widowallowance.index');
            }else{
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(WidowAllowance $widowAllowance)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, WidowAllowance $widowAllowance)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(WidowAllowance $widowAllowance)
    {
        //
    }
}
